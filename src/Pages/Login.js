...
export default function Login({ setIsloggedin }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 gradient">
      ...
      {showToast && (
        <div className="fixed z-50 right-4 top-20 sm:top-28 w-[90vw] sm:max-w-xs md:max-w-sm lg:max-w-md flex items-start sm:items-center p-4 text-sm text-gray-700 bg-white rounded-lg shadow dark:text-gray-200 dark:bg-gray-800 space-x-3 transition-opacity duration-300 ease-in-out">
          ...
          <button
            ...
            className="ml-auto -mx-1.5 -my-1.5 text-gray-400 hover:text-gray-900 rounded-lg p-1.5 hover:bg-gray-100 focus:ring-2 focus:ring-gray-300 dark:text-gray-500 dark:hover:text-white dark:hover:bg-gray-700"
            aria-label="Close"
          >
